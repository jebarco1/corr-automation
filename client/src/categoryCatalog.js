...
export const categories = [
  {
    ...
    questions: [
      ...
      { key: "squareFeet", question: "What is the estimated service area in square feet?", type: "number", required: true, api: "mowable-area" },
  ...
  },
  {
    ...
    questions: [
      ...
      { key: "propertyType", question: "What type of property is this?", type: "select", options: ["residential", "commercial", "hoa", "multi-family", "industrial"], required: true },
      { key: "squareFeet", question: "What is the conditioned building square footage?", type: "number", required: true, api: "hvac-load-estimate" },
  ...
  },
  {
    ...
    questions: [
      ...
      { key: "serviceAddress", question: "What is the service address?", type: "string", required: true },
      { key: "propertyType", question: "What type of property is this?", type: "select", options: ["residential", "commercial", "hoa", "multi-family", "industrial"], required: true },
      { key: "squareFeet", question: "How many square feet must be cleaned?", type: "number", required: true, api: "cleaning-property-profile" },
  ...
  },
  {
    ...
    questions: [
      ...
      { key: "serviceAddress", question: "What is the service address?", type: "string", required: true },
      { key: "propertyType", question: "What type of property is this?", type: "select", options: ["residential", "commercial", "hoa", "multi-family", "industrial"], required: true },
      { key: "squareFeet", question: "What is the treatment area square footage?", type: "number", required: true, api: "pest-property-profile" },
  ...
  },
  {
    ...
    questions: [
      ...
      { key: "serviceAddress", question: "What is the service address?", type: "string", required: true },
      { key: "propertyType", question: "What type of property is this?", type: "select", options: ["residential", "commercial", "hoa", "multi-family", "industrial"], required: true },
      { key: "squareFeet", question: "What surface area will be painted?", type: "number", required: true, api: "paint-surface-area" },
  ...
  },
  {
    ...
    questions: [
      ...
      { key: "serviceAddress", question: "What is the service address?", type: "string", required: true },
      { key: "propertyType", question: "What type of property is this?", type: "select", options: ["residential", "commercial", "hoa", "multi-family", "industrial"], required: true },
      { key: "squareFeet", question: "What is the roof footprint square footage?", type: "number", required: true, api: "roof-area-estimate" },
